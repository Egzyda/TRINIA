 ...
 */
import { ChevronLeft, Coins, Gavel, Hand, Layers, Swords, Timer } from 'lucide-react';
      ...
      <div className="screen-scroll">
        <div className="tutorial">
          <section>
            ...
            <p>
              互いの拠点HPは {RULES.BASE_HP}。相手の拠点HPを0にすれば勝ちです。
          ...
          <section>
            ...
            <p>
              対局開始時、両者が「先攻権に支払う拠点HP」を同時に提示します（0〜{RULES.MAX_BID}）。
            </p>
            <ul>
          ...
          <section>
            ...
            <p>
              ...
              毎ターン開始時に{RULES.FREE_POINTS}ptが無条件で与えられ、
          ...
          <section>
            ...
            <ul>
              <li>ドロー: 山札から1枚引く</li>
              <li>分配: {RULES.FREE_POINTS}ptを振り分ける</li>
